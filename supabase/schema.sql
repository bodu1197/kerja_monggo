...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    CONSTRAINT "profiles_role_check" CHECK ((("role")::"text" = ANY (ARRAY[('user'::character varying)::"text", ('admin'::character varying)::"text", ('moderator'::character varying)::"text"])))
);
...
CREATE UNIQUE INDEX "favorites_user_slug_key" ON "public"."favorites" USING "btree" ("user_id", "product_slug");
...
CREATE INDEX "idx_comments_slug_created" ON "public"."product_comments" USING "btree" ("product_slug", "created_at" DESC);
...
CREATE INDEX "idx_favorites_slug" ON "public"."favorites" USING "btree" ("product_slug");
...
CREATE INDEX "idx_product_comments_slug" ON "public"."product_comments" USING "btree" ("product_slug", "created_at" DESC);
...
CREATE INDEX "idx_product_images_slug" ON "public"."product_images" USING "btree" ("product_slug", "order");



CREATE INDEX "idx_product_images_slug_order" ON "public"."product_images" USING "btree" ("product_slug", "order");
...
CREATE INDEX "idx_products_composite" ON "public"."products" USING "btree" ("status", "expires_at", "regency_id", "category_id") WHERE (("status")::"text" = 'active'::"text");
...
CREATE INDEX "idx_products_latitude" ON "public"."products" USING "btree" ("latitude");
...
CREATE INDEX "idx_products_longitude" ON "public"."products" USING "btree" ("longitude");
...
CREATE INDEX "idx_products_search" ON "public"."products" USING "gin" ("to_tsvector"('"indonesian"'::"regconfig", ((("title")::"text" || ' '::"text") || COALESCE("description", ''::"text"))));
...
CREATE INDEX "idx_products_status_expires" ON "public"."products" USING "btree" ("status", "expires_at") WHERE (("status")::"text" = 'active'::"text");
...
CREATE INDEX "idx_view_history_slug" ON "public"."view_history" USING "btree" ("product_slug", "viewed_at" DESC);
...
ALTER TABLE ONLY "public"."favorites"
    ADD CONSTRAINT "favorites_product_slug_fkey" FOREIGN KEY ("product_slug") REFERENCES "public"."products"("slug") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."product_comments"
    ADD CONSTRAINT "product_comments_product_slug_fkey" FOREIGN KEY ("product_slug") REFERENCES "public"."products"("slug") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."product_images"
    ADD CONSTRAINT "product_images_product_slug_fkey" FOREIGN KEY ("product_slug") REFERENCES "public"."products"("slug") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."reports"
    ADD CONSTRAINT "reports_product_slug_fkey" FOREIGN KEY ("reported_product_slug") REFERENCES "public"."products"("slug") ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."view_history"
    ADD CONSTRAINT "view_history_product_slug_fkey" FOREIGN KEY ("product_slug") REFERENCES "public"."products"("slug") ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE POLICY "Authenticated users can insert comments" ON "public"."product_comments" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Product owner can mark as seller reply" ON "public"."product_comments" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."products"
  WHERE (("products"."slug" = "product_comments"."product_slug") AND ("products"."user_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."products"
  WHERE (("products"."slug" = "product_comments"."product_slug") AND ("products"."user_id" = "auth"."uid"())))));



CREATE POLICY "Product owners and admins can delete images" ON "public"."product_images" FOR DELETE TO "authenticated" USING (((EXISTS ( SELECT 1
   FROM "public"."products"
  WHERE (("products"."slug" = "product_images"."product_slug") AND ("products"."user_id" = "auth"."uid"())))) OR (EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND (("profiles"."role")::"text" = 'admin'::"text"))))));



CREATE POLICY "Product owners and admins can insert images" ON "public"."product_images" FOR INSERT TO "authenticated" WITH CHECK (((EXISTS ( SELECT 1
   FROM "public"."products"
  WHERE (("products"."slug" = "product_images"."product_slug") AND ("products"."user_id" = "auth"."uid"())))) OR (EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND (("profiles"."role")::"text" = 'admin'::"text"))))));
...
CREATE POLICY "Product owners and admins can update images" ON "public"."product_images" FOR UPDATE TO "authenticated" USING (((EXISTS ( SELECT 1
   FROM "public"."products"
  WHERE (("products"."slug" = "product_images"."product_slug") AND ("products"."user_id" = "auth"."uid"())))) OR (EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND (("profiles"."role")::"text" = 'admin'::"text"))))));
...
CREATE POLICY "Users can delete their own comments" ON "public"."product_comments" FOR DELETE TO "authenticated" USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can delete their own history" ON "public"."view_history" FOR DELETE TO "authenticated" USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can insert their own history" ON "public"."view_history" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can update their own comments" ON "public"."product_comments" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view their own history" ON "public"."view_history" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));
