export default function JobCard({ job }) {
  return (
    <div style={{background: 'white', borderRadius: '12px', padding: '20px', border: '2px solid #e5e7eb', cursor: 'pointer', transition: 'all 0.3s', boxShadow: '0 2px 4px rgba(0,0,0,0.04)', width: '100%'}} className="hover:shadow-[0_6px_20px_rgba(0,0,0,0.12)] hover:-translate-y-1 hover:border-[#2c3e50]">
