    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">구인 공고를 등록하려면 로그인해주세요</p>
          <button
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">구인자만 이용 가능합니다</h2>
          <p className="text-gray-600 mb-2">구인 공고는 구인자 회원만 등록할 수 있습니다.</p>
          {!userType && (
            <p className="text-sm text-gray-500 mb-6">회원 유형을 선택하지 않으셨습니다.</p>
          )}
